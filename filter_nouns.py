...
if __name__ == "__main__":
    _dict = {"CIFAR-10": 167, "CIFAR-20": 167, "STL-10": 17, "ImageNet-10": 43, "ImageNet-Dogs": 65,
             "DTD": 141, "UCF101": 303, "ImageNet": 4271, "Tiny-ImageNet": 334, "CUB-200": 39, "AID": 33}
    dataset = "AID"
    cluster_num = _dict[dataset]  # [167, 167, 17, 43, 65, 141, 303, 4271]
    topK = 5
    ...
    try:
        ...
        print(f"Runningg time:{time.time() - start_time}/s.")
